...
<div>
  <div class="max-w-container-max mx-auto">
    <div class="mb-6">
      ...
      <p class="font-body-md text-on-surface-variant">Daftar draft yang perlu ditandatangani atau disetujui oleh Ketua atau Admin.</p>
    </div>
      ...
      <table class="w-full">
        <thead class="bg-slate-50 border-b border-slate-100">
          <tr>
            ...
            <th class="text-left px-4 py-3 text-[12px] font-bold text-slate-500">Ketua</th>
        ...
        <tbody class="divide-y">
          ...
          <tr class="hover:bg-slate-50/60 transition-colors">
            ...
            <td class="px-4 py-4">{{ $d->ketua?->name ?? '-' }}</td>
            <td class="px-4 py-4">{{ $d->status_label }}</td>
            <td class="px-4 py-4">
              <a href="#" class="text-blue-600 hover:underline" onclick="featureInDevelopment('Open review')">Open</a>
            </td>
          </tr>
          @empty
          <tr>
            <td colspan="5" class="px-6 py-8 text-center text-gray-500">Tidak ada dokumen untuk ditandatangani.</td>
          </tr>
          @endforelse
        </tbody>
      </table>
